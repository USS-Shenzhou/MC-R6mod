 ...
 * @author USS_Shenzhou
 */
public class GasSmokeParticleData implements IParticleData {
    private final Vector3d speed;
    private final Color color;
    private final float diameter;
    public static final IDeserializer<GasSmokeParticleData> DESERIALIZER = new IDeserializer<GasSmokeParticleData>() {

        @Override
        public GasSmokeParticleData deserialize(ParticleType<GasSmokeParticleData> particleTypeIn, StringReader reader) throws CommandSyntaxException {
            ...
            return new GasSmokeParticleData(new Vector3d(speedX, speedY, speedZ), new Color(red, green, blue, alpha), diameter);
        }

        @Override
        public GasSmokeParticleData read(ParticleType<GasSmokeParticleData> particleTypeIn, PacketBuffer buffer) {
            final int MIN_COLOUR = 0;
            final int MAX_COLOUR = 255;
    ...
    public GasSmokeParticleData(Vector3d speed, Color color, float diameter) {
        this.speed = speed;
        this.color = color;
    ...
    public ParticleType<?> getType() {
        return ModParticleTypeRegistry.GAS_SMOKE_PARTICLE.get();
    }
