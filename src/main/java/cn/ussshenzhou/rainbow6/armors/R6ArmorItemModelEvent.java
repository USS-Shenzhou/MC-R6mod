...
public class R6ArmorItemModelEvent {
    ...
    public static void onModelLoad(ModelRegistryEvent event) {
        ModelLoader.addSpecialModel(new ModelResourceLocation(ModArmors.alexHelmet.getRegistryName()+"_hand","inventory"));
        ModelLoader.addSpecialModel(new ModelResourceLocation(ModArmors.alexChestplate.getRegistryName()+"_hand","inventory"));
        ModelLoader.addSpecialModel(new ModelResourceLocation(ModArmors.alexLeggings.getRegistryName()+"_hand","inventory"));
        ModelLoader.addSpecialModel(new ModelResourceLocation(ModArmors.alexBoots.getRegistryName()+"_hand","inventory"));
    }
    ...
    public static void onModelBake(ModelBakeEvent event) {
        ...
        changeInventoryModel(modelMap,ModArmors.alexHelmet);
        changeInventoryModel(modelMap,ModArmors.alexChestplate);
        changeInventoryModel(modelMap,ModArmors.alexLeggings);
        changeInventoryModel(modelMap,ModArmors.alexBoots);
