...
public class Barricade extends Block {
    ...
    protected static final VoxelShape TOP_NORTH = Block.makeCuboidShape(0.0D,0.0D,-1.0D,16.0D,16.0D,0.0D);
    protected static final VoxelShape TOP_SOUTH = Block.makeCuboidShape(0.0D,0.0D,16.0D,16.0D,16.0D,17.0D);
    protected static final VoxelShape TOP_WEST = Block.makeCuboidShape(-1.0D,0.0D,0.0D,0.0D,16.0D,16.0D);
    protected static final VoxelShape TOP_EAST = Block.makeCuboidShape(16.0D,0.0D,0.0D,17.0D,16.0D,16.0D);
    ...
    protected static final VoxelShape WINDOW_BOTTOM_WEST = Block.makeCuboidShape(15.0D,-5.0D,0.0D,0.0D,16.0D,16.0D);
    protected static final VoxelShape WINDOW_BOTTOM_EAST = Block.makeCuboidShape(0.0D,-5.0D,0.0D,1.0D,16.0D,16.0D);

    protected static final VoxelShape WINDOW_TOP_NORTH = Block.makeCuboidShape(0.0D,0.0D,15.0D,16.0D,16.0D,16.0D);
    protected static final VoxelShape WINDOW_TOP_SOUTH = Block.makeCuboidShape(0.0D,0.0D,0.0D,16.0D,16.0D,1.0D);
    protected static final VoxelShape WINDOW_TOP_WEST = Block.makeCuboidShape(15.0D,0.0D,0.0D,16.0D,16.0D,16.0D);
    protected static final VoxelShape WINDOW_TOP_EAST = Block.makeCuboidShape(0.0D,0.0D,0.0D,1.0D,16.0D,16.0D);
    ...
    public void onBlockPlacedBy(World worldIn, BlockPos pos, BlockState state, @Nullable LivingEntity placer, ItemStack stack) {
        if (placer instanceof PlayerEntity){
            ...
            if (direction == Direction.UP||direction == Direction.DOWN){
                ItemStack returnStack = new ItemStack(Items.MILK_BUCKET);
